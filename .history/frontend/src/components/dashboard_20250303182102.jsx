    ...
    <div className="dashboard min-h-screen bg-gray-100 overflow-x-hidden">
            ...
            {["Settlement"].map((item) => (
              <li key={item} className="relative group">
                ...
                <div className="absolute left-0 mt-0 w-40 bg-[#16a2ba] text-white opacity-0 group-hover:opacity-100 group-hover:block transition-all duration-200 ease-in-out">
                  <a href="#" className="block px-4 py-2 hover:bg-[#107a8d] border-b-1 border-gray-500">
                    User
                  </a>
            ...
            {[ "Reports"].map((item) => (
              <li key={item} className="relative group">
                ...
                <div className="absolute left-0 mt-0 w-40  bg-[#16a2ba] text-white opacity-0 group-hover:opacity-100 group-hover:block transition-all duration-200 ease-in-out">
                  ...
                  <a href="#" className="block px-4 py-2 hover:bg-opacity-50  border-b-1 border-gray-500">
                    IP lookup
                  </a>
      ...
      <header>
        <div>
          ...
          <div>
          <div>
                <label htmlFor="">User ID:<span>776demo</span></label> 
                <label htmlFor="">User Type:<span>Admin</span></label> 
            </div>
            <div>
                <label htmlFor="">Given Bal:<span>1000.00</span></label> 
                <label htmlFor="">Available:<span>500.00</span></label> 
            </div>
          </div>
