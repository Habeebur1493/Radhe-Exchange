...
const Sidebar = () => {
  ...
  return (
    <div className="relative">
      ...
      {/* Sidebar */}
      <div
  className={`sidebar fixed top-0 left-0 w-52 h-full bg-[--tertiary-background] text-white transition-transform duration-300 z-0 ${
    isOpen ? "translate-x-0" : "-translate-x-full"
  }`}
  style={{ overflowY: "auto", paddingTop: "3.5rem" }} // Adjust padding to prevent overlap with navbar
>
