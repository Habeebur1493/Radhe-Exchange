          ...
          <div className="flex justify-center items-center p-4 text-[14px]">
            <table className="border-collapse border border-gray-400 ">
              <thead>
                ...
                {/* second row*/}
                <tr className="bg-[#f2f2f2] text-white">
                  <th className="border border-gray-400 p-2 pr-5 text-left ">
                    User Name<i className="text-white font-light ri-arrow-up-down-fill"></i>
                  </th>
                  <th className="border border-gray-400 p-2 pr-10 text-left">
                  ...
                  <th className="border border-gray-400 p-2 pr-5 text-left">
                    500<i className="text-white font-light ri-arrow-up-down-fill"></i>
                  </th>
                  <th className="border border-gray-400 p-2 pr-5 text-left">
                    -500.00<i className="text-white font-light ri-arrow-up-down-fill"></i>
                  </th> 
                  <th className="border border-gray-400 p-2 pr-10 text-left">
                    500.00<i className="text-white font-light ri-arrow-up-down-fill"></i>
                  </th>
                  <th className="border border-gray-400 p-2 pr-5 text-left">
                    0.00<i className="text-white font-light ri-arrow-up-down-fill"></i>
                  </th>
                  <th className="border border-gray-400 p-2 pr-5 text-left">
                    0.00<i className="text-white font-light ri-arrow-up-down-fill"></i>
                  </th>
