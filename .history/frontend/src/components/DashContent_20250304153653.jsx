...
<div className="flex flex-col w-[23%] bg-white rounded-sm shadow-lg overflow-hidden">
  ...
  <table className="w-full text-[12px] font-bold">
    ...
    <tbody>
      <tr>
        <td className="p-2 text-left">Player 1</td>
        <td className="p-2 text-right">$1000</td>
      </tr>
      <tr>
        <td className="p-2 text-left">Player 2</td>
        <td className="p-2 text-right">$900</td>
      </tr>
      <tr>
        <td className="p-2 text-left">Player 3</td>
        <td className="p-2 text-right">$850</td>
      </tr>
      <tr>
        <td className="p-2 text-left">Player 4</td>
        <td className="p-2 text-right">$800</td>
      </tr>
      <tr>
        <td className="p-2 text-left">Player 5</td>
