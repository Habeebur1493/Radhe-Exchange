            ...
            <table className="border-collapse border border-gray-400 ">
              <thead>
                ...
                <tr className="bg-white text-black">
                  ...
                  <th className="border border-gray-400 p-2 gap-2 text-right">
                  <button className=" cursor-pointer bg-orange-400 hover:bg-gray-400 font-extrabold text-[10px] p-1 rounded-sm">U</button>
                  <button className=" cursor-pointer bg-green-800 hover:bg-gray-400 font-extrabold text-[10px] p-1 rounded-sm">D|C</button>
                  <button className=" cursor-pointer bg-blue-900 hover:bg-gray-400 font-extrabold text-[10px] p-1 rounded-sm">W</button>
                  <button className=" cursor-pointer bg-yellow-400 hover:bg-gray-400 font-extrabold text-[10px] p-1 rounded-sm">P</button>
                  <button className=" cursor-pointer bg-pink-400 hover:bg-gray-400 font-extrabold text-[10px] p-1 rounded-sm">GC</button>
                  <button className=" cursor-pointer bg-green-400 hover:bg-gray-400 font-extrabold text-[10px] p-1 rounded-sm">CC</button>
