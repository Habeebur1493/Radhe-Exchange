...
const Dashboard = () => {
  ...
  return (
    <div className="dashboard min-h-screen bg-gray-100 overflow-x-hidden">
      ...
      >
       <i className={`fa-solid fa-angle-down bg-white text-black font-bold rounded-full p-2 transition-transform ${isOpen ? "rotate-180" : ""}`}></i>
      ...
      {/* Dropdown Content */}
      {isOpen && (
        <div className="bg-[#007182]  transition-all duration-300">
          <div className="flex justify-evenly items-center text-white">
  <div className="flex flex-col text-center">
    <h4>User ID: 776demo</h4>
    <h4>User Type: Admin</h4>
  </div>

  <div className="flex flex-col text-center">
    <h4>Given Bal: 1000.00</h4>
    <h4>Available: 500.00</h4>
  </div>
