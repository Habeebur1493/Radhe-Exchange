...
const Dashboard = () => {
  ...
  return (
    <div className="dashboard min-h-screen bg-gray-200 overflow-x-hidden fixed top-0 left-0 w-full bg-white shadow-md z-50">
      {/* Navbar */}
      <nav className="bg-[--primary-background] text-white flex items-center lg:h-14 h-10 px-4 shadow-md   ">
  <Sidebar />
    ...
    <ul className=" md:flex text-sm font-medium">
      ...
      <header className="bg-[#007182] p-1  ">
        ...
        {isOpen && (
          ...
          <div className="grid grid-cols-2 gap-4 sm:grid-cols-2 lg:flex lg:justify-evenly items-center text-white text-[10px] sm:text-[12px] lg:text-[14px] w-full mr-4">
