          ...
          <ul className="hidden md:flex space-x-3">
            ...
            {["Settlement"].map((item) => (
              <li key={item} className="relative group">
                ...
                <div className="absolute left-0 mt-0 w-40 bg-[#18b0c7] text-white opacity-0 group-hover:opacity-100 group-hover:block transition-all duration-200 ease-in-out">
                  <a href="#" className="block px-4 py-2  border-b-1 border-[#18b0c7]">
                    User
                  </a>
            ...
            {[ "Reports"].map((item) => (
              <li key={item} className="relative group">
                ...
                {/* Dropdown - Show on Hover */}
                <div className="absolute left-0 mt-1 w-40 bg-[#18b0c7] text-white opacity-0 group-hover:opacity-100 group-hover:block transition-all duration-200 ease-in-out">
                  <a href="#" className="block px-4 py-2 hover:bg-opacity-50">
                    User Detail
                  </a>
                  <a href="#" className="block px-4 py-2 hover:bg-opacity-50">
