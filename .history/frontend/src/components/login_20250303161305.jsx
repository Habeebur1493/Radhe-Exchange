    ...
    <div className="main flex items-center justify-center min-h-screen bg-[--primary-background]">
      <div className="bg-black p-6 w-75 h-100 border-[5px] border-[#3d3636]">
        ...
        <form className="space-y-4 text-[14px]">
          ...
          {/* CAPTCHA */}
          <div className="flex justify-center items-center space-x-3 bg-[#d4d4d4] rounded-lg p-2 mb-5">
          ...
          <button
            type="submit"
            className="w-full bg-blue-500 text-white py-2 rounded-lg hover:bg-blue-600 font-bold"
          >
            LOGIN
          </button>
        </form>
