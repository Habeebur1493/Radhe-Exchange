     ...
     <div className="flex justify-between items-center mt-4">
          ...
          <table className="w-full text-[12px] font-bold border-collapse">
            <thead>
              <tr className=" border-gray-400">
                ...
                <th className="p-2 text-right w-1/3 border-b border-gray-400 ">Amount</th>
              </tr>
        ...
        <div className="flex flex-col w-[23%] bg-white rounded-sm shadow-lg overflow-hidden">
          ...
          <table className="w-full text-[12px] font-bold border-collapse">
            <thead>
            <tr className=" border-gray-400">
                <th className="pt-1 text-left pl-1  w-2/3">
                  <select name="" id="" className="bg-white border border-gray-500 p-2 rounded-sm">
