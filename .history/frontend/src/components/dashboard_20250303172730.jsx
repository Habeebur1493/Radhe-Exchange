        ...
        <div className="ml-6 flex items-center">
          <ul className="hidden md:flex space-x-3">
            {["Dashboard", "Clients", "Sport Analysis", "Casino Analysis"].map((item) => (
              <li key={item}>
                <a href="#" className="h-14 flex items-center px-3 hover:bg-[#18b0c7] transition-all duration-200 ease-in-out">
                  {item}
                </a>
              </li>
            ))}
            ...
            {["Settlement", "Reports", "Cutting", "Control"].map((item) => (
              <li key={item} className="relative">
                <button className="h-14 flex items-center px-3 hover:bg-[#18b0c7] transition-all duration-200 ease-in-out">
                  {item}
          ...
          <ul className="hidden md:flex text-sm font-medium ml-100">
