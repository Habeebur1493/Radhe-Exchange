...
const Dashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 overflow-x-hidden">
      {/* Navbar */}
      <nav className="bg-[--primary-background] text-white flex justify-between items-center h-15 ">
        ...
        {/* Navbar Links */}
        <ul className="hidden md:flex space-x-4 mr-100">
          <li><a href="#" className="hover:bg-[#18b0c7] px-4 py-5">Dashboard</a></li>
          <li><a href="#" className="hover:bg-[#18b0c7] px-4 py-5">Clients</a></li>
          <li><a href="#" className="hover:bg-[#18b0c7] px-4 py-5">Sport Analysis</a></li>
          <li><a href="#" className="hover:bg-[#18b0c7] px-4 py-5">Casino Anbg-alysis</a></li>
          ...
          {["Settlement", "Reports", "Cutting", "Control"].map((item) => (
            <li key={item} className="relative group">
              ...
              {/* Dropdown */}
              <div className="absolute left-0 mt-2 w-40 bg-[#18b0c7] text-gray-800 shadow-lg  hidden group-hover:block">
