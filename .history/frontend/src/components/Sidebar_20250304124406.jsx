...
const Sidebar = () => {
  ...
  return (
    <div className="relative">
      ...
      >
        <ul className="space-y-2 spce-x-4 ">
          {/* Cricket */}
          <li className="cursor-pointer">
            <div className="flex justify-between items-center hover:bg-[#5dcbde] p-2" onClick={() => toggleDropdown("cricket")}>
          ...
          {/* Soccer */}
          <li className="cursor-pointer">
            <div className="flex justify-between items-center hover:bg-[#5dcbde] p-2" onClick={() => toggleDropdown("soccer")}>
          ...
          {/* Tennis */}
          <li className="cursor-pointer">
            <div className="flex justify-between items-center hover:bg-[#5dcbde] p-2" onClick={() => toggleDropdown("tennis")}>
          ...
          {/* Greyhound */}
          <li className="cursor-pointer">
            <div className="flex justify-between items-center hover:bg-[#5dcbde] p-2" onClick={() => toggleDropdown("greyhound")}>
