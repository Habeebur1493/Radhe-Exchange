    ...
    <ul className=" md:flex text-sm font-medium">
      ...
      <header className="bg-[#007182] p-1  ">
        ...
        {isOpen && (
          ...
          <div className="grid grid-cols-2 lg:gap-4 sm:grid-cols-2 lg:flex lg:justify-evenly items-center text-white text-[10px] sm:text-[12px] lg:text-[14px] w-full mr-4">
