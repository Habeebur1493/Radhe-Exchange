...
const Dashboard = () => {
  ...
  return (
    <div className="dashboard min-h-screen bg-gray-100 overflow-x-hidden">
      ...
      {/* Dropdown Toggle */}
      <div className="cursor-pointer flex items-center space-x-2" onClick={() => setIsOpen(!isOpen)}>
      ...
      {/* Dropdown Content */}
      {isOpen && (
        <div className="mt-2 bg-white p-4 shadow-lg rounded-lg transition-all duration-300">
          <div className="grid grid-cols-3 gap-4 text-gray-800">
            ...
            <div>
              <label className="block font-semibold">Given Bal:</label>
              <span>1000.00</span>
            </div>
            <div>
            ...
            <div>
              <label className="block font-semibold">Up Line:</label>
              <span>0</span>
            </div>
            <div>
              <label className="block font-semibold">Down Line:</label>
              <span>0</span>
            </div>
            <div>
              <label className="block font-semibold">Current P&L:</label>
              <span>0</span>
            </div>
            <div>
              <label className="block font-semibold">Exposure:</label>
              <span>0</span>
            </div>
            <div>
              <label className="block font-semibold">My P&L:</label>
              <span>0</span>
            </div>
          </div>
        </div>
