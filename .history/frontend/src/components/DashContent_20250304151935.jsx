...
{/* Cards -2 */}
        ...
        <div className="flex justify-between items-center mt-4">
          <div className="flex flex-col h-10 w-[23%] bg-white">
            <h1 className="bg-[#16a2ba] p-2 text-black font-bold text-[15px] rounded-t-sm">TOP 5 WINNING PLAYER</h1>
          ...
          <div className="flex flex-col h-10 w-[23%] bg-white">
          <h1 className="bg-[#16a2ba] p-2 text-black font-bold text-[15px] rounded-t-sm">TOP 5 LOOSING PLAYER</h1>
            <div className="flex justify-between p-2 text-[12px] font-bold bg-white">
              <p>Player</p>
              <p>Amount</p>
            </div>
          ...
          <div className="flex flex-col h-10 w-[23%] bg-white">
          <h1 className="bg-[#16a2ba] p-2 text-black font-bold text-[15px] rounded-t-sm">TOP 5 WINNING MARKETS</h1>
            <div className="flex justify-between p-2 text-[12px] font-bold bg-white">
              <p>Sport</p>
              <p>Market</p>
              <p>Amount</p>
          ...
          <div className="flex flex-col h-10 w-[23%] bg-white">
          <h1 className="bg-[#16a2ba] p-2 text-black font-bold text-[15px] rounded-t-sm">TOP 5 LOOSING MARKETS</h1>
            <div className="flex justify-between p-2 text-[12px] font-bold bg-white">
            <p>Sport</p>
              <p>Market</p>
              <p>Amount</p>
