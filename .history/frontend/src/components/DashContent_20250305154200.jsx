  ...
  <div className="flex flex-col w-full sm:w-[23%] bg-white rounded-sm shadow-lg overflow-hidden">
    ...
    <table className="w-full text-[12px] font-bold border-collapse">
      <thead>
        ...
        <tr className="bg-[#f2f2f2] border-gray-400">
          <th className="p-1 text-left pl-4 border-b-0 border border-gray-400 font-normal w-2/3">Total P&L</th>
          <th className="p-1 text-right w-1/3 font-normal border-b-0 border border-gray-400">0</th>
        </tr>
      </thead>
    </table>
  </div>
