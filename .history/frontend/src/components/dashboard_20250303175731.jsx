            ...
            {["Settlement"].map((item) => (
              <li key={item} className="relative group">
                ...
                <div className="absolute left-0 mt-0 w-40 bg-[#16a2ba] text-white opacity-0 group-hover:opacity-100 group-hover:block transition-all duration-200 ease-in-out">
                  <a href="#" className="block px-4 py-2  border-b-1 border-gray-500">
                    User
                  </a>
            ...
            <li className="relative">
              ...
              {isDropdownOpen && (
                <div className="absolute right-0 mt-1 w-40 bg-white text-gray-800 shadow-md rounded-md">
                  ...
                  <i class="ri-arrow-right-long-line"></i> Change Password
                  </a>
                  <a href="#" className="block px-4 py-2 hover:bg-gray-200">
                  <i class="ri-arrow-right-long-line"></i> Log Out
                  </a>
                </div>
              )}
            </li>
