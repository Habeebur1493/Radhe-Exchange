...
const navItems = [
  { key: "Dashboard", label: "Dashboard", path: "/dashboard", icon: "/src/images/boy.png" },
  { key: "Client", label: "Client", path: "/client", icon:"/src/images/boy.png" },
  { key: "SportAnalysis", label: "Sport Analysis", path: "/sport-analysis", icon: "/src/images/qa.png" },
  { key: "CasinoAnalysis", label: "Casino Analysis", path: "/casino-analysis", icon: "/src/images/casino.png" },
  {
    key: "Settlement",
    label: "Settlement",
    icon: "/src/images/settlement.png",
    items: [
  ...
  return (
    ...
    {navItems.map(({ key, label, path, icon, items }) => (
      <li key={key} className="text-[12px]">
        {items ? (
          <div
            className="flex justify-between items-center w-full  border-b border-[#18b0c7] cursor-pointer hover:bg-[#5dcbde] transition-all"
