  ...
  return (
    <div className="client flex justify-center items-center min-h-screen bg-gray-300">
      <div className="h-screen lg:h-[700px]  w-full max-w-8xl bg-white rounded-lg m-4 p-4">
        <h1 className="font-bold text-[16px] pl-2 pt-2">
...
<div className="flex items-center justify-between gap-6 mt-15">
  <div className="w-2/3">
  ...
  <button
    type="submit"
    className="bg-blue-500 text-white px-4 py-2 mt-2 rounded hover:bg-blue-600 w-1/4"
  >
    Create Account
  </button>
</div>
