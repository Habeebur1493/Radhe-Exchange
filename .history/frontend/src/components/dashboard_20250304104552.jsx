...
<header className="bg-[#007182] p-4 shadow-md">
  ...
  <div className="relative">
    ...
    >
      <i
        className={`ri-arrow-down-s-line bg-white font-bold rounded-full p-1 transition-transform ${
          isOpen ? "rotate-180" : ""
        }`}
      ></i>
    </div>
    ...
    {/* Dropdown Content */}
    {isOpen && (
      <div className="absolute left-0 mt-2 w-full bg-white text-black shadow-md p-4">
