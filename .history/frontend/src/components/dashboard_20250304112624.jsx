      ...
      <header className="bg-[#007182] p-2  ">
        ...
        {isOpen && (
          ...
          <div className="flex justify-between items-center text-white text-[14px] ml-2">
            ...
            <div className="flex flex-col text-center gap-2">
              <h4 className="flex">Given Bal: <span className="text-[#20fa5e] ml-5">1000.00</span></h4>
              <h4 className="flex">Available: <span className="text-[#20fa5e] ml-10">500.00</span></h4>
            </div>
