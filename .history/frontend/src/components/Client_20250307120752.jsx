  ...
  <div className="h-auto lg:h-[700px]  w-full max-w-8xl bg-white rounded-lg m-4">
    ...
    <div className="flex flex-wrap items-center justify-between gap-2 p-4">
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        <button className="border border-gray-600 bg-gray-200 p-2 rounded-sm">Active List</button>
      </div>
    </div>

    {/* Table Wrapper to Make It Scrollable */}
    <div className="w-full overflow-x-auto">
      <table className="border-collapse border border-gray-400 w-full min-w-[1200px] lg:m-2">
        <thead>
