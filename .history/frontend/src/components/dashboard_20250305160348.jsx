...
const Dashboard = () => {
  ...
  <div className="ml-auto">
    <ul className=" md:flex text-sm font-medium">
      ...
      <DashContent />
      <footer className="footer h-8 bg-[--secondary-background] text-white text-center">
        <h1> 1️⃣Welcome To Our Exchange...... 2️⃣ ICC Champions Trophy Cup TOURNAMENT 
          WINNER Bet Started In Our Exchange..... 💫💫💫</h1>
      </footer>
    </div>
  );
};
