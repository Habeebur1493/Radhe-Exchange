        ...
        <div className="h-[700px] w-[1490px] bg-white rounded-lg">
          ...
          <div className="flex justify-between items-center pl-5 pr-5 text-[14px]">
            ...
            <div className="flex justify-between items-center gap-2">
              ...
              <button className="btn2 border border-gray-600 bg-[--secondary-background] p-2 rounded-sm">Inactive List</button>
            </div>
          </div>
            ...
            <table className="border-collapse border border-gray-400">
              <thead>
                <tr className="bg-[#016a82] text-white">
                  <th className="border border-gray-400 p-2 pr-5 text-left">User Name<i class="ri-arrow-up-down-fill"></i></th>
                  <th className="border border-gray-400 p-2 pr-5 text-left">Credit Reference<i class="ri-arrow-up-down-fill"></i></th>
                  <th className="border border-gray-400 p-2 pr-5 text-left">Balance<i class="ri-arrow-up-down-fill"></i></th>
                  <th className="border border-gray-400 p-2 pr-5 text-left">Pending Bal.<i class="ri-arrow-up-down-fill"></i></th>
                  <th className="border border-gray-400 p-2 pr-10 text-left">Available Bal.<i class="ri-arrow-up-down-fill"></i></th>
                  <th className="border border-gray-400 p-2 pr-5 text-left">Current P&L<i class="ri-arrow-up-down-fill"></i></th>
                  <th className="border border-gray-400 p-2 pr-5 text-left">Exposure<i class="ri-arrow-up-down-fill"></i></th>
                  <th className="border border-gray-400 p-2 pr-5 text-left">U Lock<i class="ri-arrow-up-down-fill"></i></th>
                  <th className="border border-gray-400 p-2 pr-5 text-left">B Lock<i class="ri-arrow-up-down-fill"></i></th>
                  <th className="border border-gray-400 p-2 pr-3 text-left">My %<i class="ri-arrow-up-down-fill"></i></th>
                  <th className="border border-gray-400 p-2 pr-5 text-left">Type<i class="ri-arrow-up-down-fill"></i></th>
                  <th className="border border-gray-400 p-2 pr-40 text-left">Actions<i class="ri-arrow-up-down-fill"></i></th>
                </tr>
              </thead>
              <tbody>
