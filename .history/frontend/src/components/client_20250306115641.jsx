            ...
            <table className="border-collapse border border-gray-400 ">
              <thead>
                ...
                <tr className="bg-white text-black">
                  ...
                  <button className=" cursor-pointer bg-green-400 hover:bg-gray-400 font-extrabold text-[10px] p-1 rounded-sm">GC</button>
                  <button className=" cursor-pointer bg-green-400 hover:bg-gray-400 font-extrabold text-[10px] p-1 rounded-sm">P</button>
                  <button className=" cursor-pointer bg-green-400 hover:bg-gray-400 font-extrabold text-[10px] p-1 rounded-sm">W</button>
                  <button className=" cursor-pointer bg-green-400 hover:bg-gray-400 font-extrabold text-[10px] p-1 rounded-sm">D|C</button>
                  <button className=" cursor-pointer bg-green-400 hover:bg-gray-400 font-extrabold text-[10px] p-1 rounded-sm">U</button>
                  </th>
                </tr>
              </thead>
            </table>
