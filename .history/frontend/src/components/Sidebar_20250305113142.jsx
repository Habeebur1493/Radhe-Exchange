  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        className="p-2 text-xl md:hidden" // Show menu icon on mobile only
      >
      ...
      {/* Sidebar */}
      <div
        className={`sidebar fixed top-0 left-0 h-full w-40 lg:w-64 md:w-80 mt-14 bg-[--tertiary-background] text-white transition-transform duration-300 ${
