        ...
        {isOpen && (
          <div className="bg-[#007182]  transition-all duration-300">
            <div className="flex justify-between items-center text-white text-[14px] ml-2">
              ...
              <div className="flex flex-col text-center gap-2">
                <h4>Given Bal: <span className="text-[#20fa5e]">1000.00</span></h4>
                <h4>Available:  <span className="text-[#20fa5e]">500.00</span></h4>
              </div>

              <div className="flex flex-col text-center">
                <h4>Up Line: <span>0</span></h4>
                <h4>Down Line: <span>0</span></h4>
              </div>

              <div className="flex flex-col text-center gap-2">
                <h4>Current P&L: <span >0</span></h4>
                <h4>Exposure: <span>0</span></h4>
              </div>

              <div className="flex flex-col text-center gap-2 mb-7">
                <h4>My P&L: <span>0</span></h4>
              </div>
            </div>
          </div>
        )}
