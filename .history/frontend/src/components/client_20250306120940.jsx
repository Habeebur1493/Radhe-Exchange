    ...
    <div>
      <div className="client flex justify-center items-center h-screen bg-gray-300">
        <div className="h-[700px] w-[1490px] bg-white rounded-lg">
          ...
          <h1>Showing 1 to 1 of 1 entries</h1>

          <div className="text-white text-[14px]">
            <button className="btn3 p-2 rounded-l-sm ">First</button>
            <button className="btn3 p-2 ">Prev</button>
            <button className="btn3 p-2 ">1</button>
            <button className="btn3 p-2 ">Next</button>
            <button className="btn3 p-2 rounded-r-sm ">Last</button>
          </div>
          </div>
