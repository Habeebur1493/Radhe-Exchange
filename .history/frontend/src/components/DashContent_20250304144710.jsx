...
const DashContent = () => {
  ...
  return (
    <div className="p-4 ">
      ...
      <div className="flex flex-row gap-7 mt-4 rounded-sm">
      <div className="h-[5%] w-[15%] bg-white rounded-sm shadow-lg">
          <h1 className="bg-[#16a2ba] p-1">P&L</h1>
          <h1 className="bg-white p-2">0</h1>
        </div>
        <div className="h-[5%] w-[15%] bg-white rounded-sm shadow-lg">
          <h1 className="bg-[#16a2ba] p-1">COMMISION</h1>
          <h1 className="bg-white p-2">0</h1>
        </div>
        <div className="h-[5%] w-[15%] bg-white rounded-sm shadow-lg">
          <h1 className="bg-[#16a2ba] p-1">DEPOSIT</h1> 
          <h1 className="bg-white p-2">0</h1>
        </div>
        <div className="h-[5%] w-[15%] bg-white rounded-sm shadow-lg">
          <h1 className="bg-[#16a2ba] p-1">WITHDRAWL</h1>
          <h1 className="bg-white p-2">0</h1>
        </div>
        <div className="h-[5%] w-[15%] bg-white rounded-sm shadow-lg">
          <h1 className="bg-[#16a2ba] p-1">TOTAL BETS</h1>
          <h1 className="bg-white p-2">0</h1>
        </div>
        <div className="h-[5%] w-[15%] bg-white rounded-sm shadow-lg">
          <h1 className="bg-[#16a2ba] p-1">SPORTBOOK P&L</h1>
          <h1 className="bg-white p-2">0</h1>
        </div>
      </div>
    </div>
