      ...
      <div className="flex justify-center items-center h-screen bg-gray-300">
        <div className="h-[700px] w-[1490px] bg-white rounded-lg">
          ...
          <div className="flex justify-between items-center gap-2">
            ...
            <button className="btn2 border bg-[--secondary-background] p-2 rounded-sm">Add Client Account</button>
            <button className="btn2 border bg-[--secondary-background] p-2 rounded-sm"> Inactive List</button>
          </div>
          </div>
