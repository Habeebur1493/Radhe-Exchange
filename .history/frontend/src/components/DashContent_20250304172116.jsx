    ...
    <div className="p-4 ">
      ...
      <div className="dash flex flex-row gap-7 mt-4">
        {[
          ...
          >
            <h1 className="bg-[#16a2ba] p-1 text-black font-normal text-[14px] rounded-t-sm">
              {item}
            </h1>
            <h1 className="bg-white text-black font-normal text-[18px] pl-2 pt-2">
              0
            </h1>
          </div>
        ))}
          ...
          <table className="w-full text-[12px] font-bold border-collapse">
            <thead>
              <tr className=" border-gray-400">
                <th className="p-2 text-left pl-4 border-b border-r border-gray-400 w-4/5">
                  Role
                </th>
                <th className="p-2 text-right w-1/3 border-b border-gray-400 ">Count</th>
              </tr>
              <tr className="bg-[#f2f2f2] border-gray-400">
                <th className="p-2 text-left pl-4 border-r font-normal border-gray-400 w-4/5">
                  Client
                </th>
                <th className="p-2 text-right font-normal w-1/3">1</th>
              </tr>
            </thead>
          </table>
        </div>
        ...
        <div className="flex flex-col w-[23%] bg-white rounded-sm shadow-lg overflow-hidden">
          ...
          <table className="w-full text-[12px] font-bold border-collapse">
            ...
            <tr className=" border-gray-400">
              ...
              <tr className="bg-[#f2f2f2] border-gray-400">
                <th className="p-2 text-left pl-4 border border-gray-400  font-normal w-4/5">
                  Total Bets
                </th>
                <th className="p-2 text-right w-1/3  border border-gray-400 font-normal">0</th>
              </tr>
              <tr className=" border-gray-400">
                <th className="p-2 text-left pl-4 border border-gray-400  font-normal w-2/3">
                  Total Bet Amount
                </th>
                <th className="p-2 text-right w-1/3 font-normal border border-gray-400">0</th>
              </tr>
              <tr className="bg-[#f2f2f2] border-gray-400">
                <th className="p-2 text-left pl-4 border border-gray-400 font-normal w-2/3">
                  Total P&L
