...
const Sidebar = () => {
  ...
  return (
    <div className="relative">
      ...
      {/* Sidebar */}
      <div
  className={`sidebar fixed top-0 left-0 h-full w-52 lg:mt-14 pt-10 z-[-50] bg-[--tertiary-background] text-white transition-transform duration-300 ${
    isOpen ? "translate-x-0" : "-translate-x-full"
  }`}
  style={{ overflowY: "auto" }} // Ensures the sidebar content scrolls instead of the entire sidebar moving
>
        <SidebarNavitems />
