          ...
          <table className="w-full text-[12px] font-bold border-collapse">
            <thead>
              <tr className=" border-gray-400">
                ...
                <th className="p-1 text-right w-1/3 border-b border-gray-400 ">
                  Count
                </th>
              </tr>
          ...
          <table className="w-full text-[12px] font-bold border-collapse">
            <thead>
              <tr className=" border-gray-400">
                <th className="p-1 text-left w-2/3">
                  <select
                    name=""
                    id=""
                    className="bg-white border border-gray-300 text-gray-500 font-normal p-2 rounded-sm"
                  >
              ...
              <tr className="bg-[#f2f2f2] border-gray-400">
                ...
                <th className="p-1 text-right w-1/3  border border-gray-400 font-normal">
                  0
                </th>
              </tr>
              <tr className=" border-gray-400">
                ...
                <th className="p-1 text-right w-1/3 font-normal border border-gray-400">
                  0
                </th>
              </tr>
              <tr className="bg-[#f2f2f2] border-gray-400">
