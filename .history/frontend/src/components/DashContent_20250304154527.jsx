...
<div className="flex justify-between items-center mt-4">
    ...
    <table className="w-full text-[12px] font-bold border-collapse">
      <thead>
        <tr className="bg-gray-200 border-gray-400">
          <th className="p-2 text-left pl-4 border-r border-gray-400 w-2/3">Player</th>
          <th className="p-2 text-right w-1/3">Amount</th>
        </tr>
      </thead>
      <tbody>
        <tr>
          <td className="p-2 text-left pl-4">Player 1</td>
  ...
  <div className="flex flex-col w-[23%] bg-white rounded-sm shadow-lg overflow-hidden">
    ...
    <table className="w-full text-[12px] font-bold border-collapse">
      <thead>
        <tr className="bg-gray-200 border-gray-400">
          <th className="p-2 text-left pl-4 border-r border-gray-400 w-1/3">Sport</th>
          <th className="p-2 text-left border-r border-gray-400 w-1/3">Market</th>
          <th className="p-2 text-right w-1/3">Amount</th>
        </tr>
      </thead>
      <tbody>
        <tr>
          <td className="p-2 text-left pl-4">Football</td>
          <td className="p-2 text-left">Over 2.5</td>
  ...
  <div className="flex flex-col w-[23%] bg-white rounded-sm shadow-lg overflow-hidden">
    ...
    <table className="w-full text-[12px] font-bold border-collapse">
      ...
      <tbody>
        <tr>
          <td className="p-2 text-left pl-4">Tennis</td>
          <td className="p-2 text-left">Match Winner</td>
          <td className="p-2 text-right">$900</td>
        </tr>
      </tbody>
    </table>
  </div>
