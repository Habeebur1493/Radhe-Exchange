            ...
            <table className="border-collapse border border-gray-400">
              <thead>
                <tr className="bg-[#016a82] text-white">
                  ...
                  <th className="border border-gray-400 p-2 pr-5 text-left">Current P&L</th>
                  <th className="border border-gray-400 p-2 pr-5 text-left">Exposure</th>
                  <th className="border border-gray-400 p-2 pr-5 text-left">U Lock</th>
                  <th className="border border-gray-400 p-2 pr-5 text-left">B Lock</th>
                  <th className="border border-gray-400 p-2 pr-3 text-left">My %</th>
