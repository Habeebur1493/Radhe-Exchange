        ...
        <ul className="space-y-2 p-2">
          {menuItems.map(({ key, label, items }) => (
            <li key={key} className="cursor-pointer">
              ...
              <ul
                className={`overflow-hidden text-[10px] bg-[#d2dcf7] h-screen text-black transition-all duration-300 ${
                  ...
                  <li key={index} className="pl-6 pr-2 py-2">
                    ...
                    <ul
                      className={`overflow-hidden transition-all duration-300 ${
                        nestedDropdowns[title] ? "h-screen opacity-100 pl-6" : "max-h-0 opacity-0"
                      }`}
                    >
