...
const DashContent = () => {
    ...
    <div className="p-4 h-screen w-full">
      ...
      <div className="h-auto w-full bg-white rounded-sm shadow-lg flex flex-row md:flex-row items-center gap-6 mt-2 p-4 flex-wrap">
        ...
        <div className="flex flex-col">
          ...
          <input
            type="datetime-local"
            className="border p-1 rounded-sm border-gray-300 lg:w-[230px] "
            value={fromDateTime}
        ...
        {/* Buttons */}
        <div className="flex flex-row md:flex-row gap-2 w-full md:w-auto justify-center mt-4 md:mt-0">
      ...
      <thead>
        <tr className="border-gray-400">
          <th className="p-1 text-left w-2/3">
            <select className="bg-white border border-gray-300 text-gray-500 font-normal p-2 rounded-sm">
        ...
        <tr className="bg-[#f2f2f2] border-gray-400">
          <th className="p-1 text-left pl-4 border border-gray-400 font-normal w-4/5">Total Bets</th>
          <th className="p-1 text-right w-1/3 border border-gray-400 font-normal">0</th>
        </tr>
        <tr className="border-gray-400">
          <th className="p-1 text-left pl-4 border border-gray-400 font-normal w-2/3">Total Bet Amount</th>
          <th className="p-1 text-right w-1/3 font-normal border border-gray-400">0</th>
        </tr>
        <tr className="bg-[#f2f2f2] border-gray-400">
          <th className="p-1 text-left pl-4 border border-gray-400 font-normal w-2/3">Total P&L</th>
          <th className="p-1 text-right w-1/3 font-normal border border-gray-400">0</th>
        </tr>
      </thead>
    </table>
  ...
  <div className="flex flex-col w-full sm:w-[23%] bg-white rounded-sm shadow-lg overflow-hidden">
    ...
    <table className="w-full text-[12px] font-bold border-collapse">
      <thead>
        <tr className="border-gray-400">
          <th className="p-1 text-left pl-4 border-l-0 border-r-0  border border-gray-400 font-normal w-4/5">Indian Poker/ Live Casino P&L</th>
          <th className="p-1 text-right w-1/3 border border-gray-400 font-normal">0</th>
        </tr>
        <tr className="bg-[#f2f2f2] border-gray-400">
          <th className="p-1 text-left pl-4 border-l-0 border-r-0  border border-gray-400 font-normal w-4/5">Indian Poker II P&L</th>
          <th className="p-1 text-right w-1/3 border border-gray-400 font-normal">0</th>
        </tr>
        <tr className="border-gray-400">
          <th className="p-1 text-left pl-4 border-l-0 border-r-0  border border-gray-400 font-normal w-2/3">Total P&L</th>
          <th className="p-1 text-right w-1/3 font-normal border border-gray-400">0</th>
        </tr>
      </thead>
    </table>
