            ...
            <table className="border-collapse border border-gray-400 ">
              <thead>
                ...
                <tr className="bg-white text-black">
                  ...
                  <th className="border border-gray-400 p-2 text-right text-white">
                  <button className=" cursor-pointer bg-orange-400 hover:bg-gray-400 font-extrabold text-[10px] p-1 m-1 rounded-sm">U</button>
                  <button className=" cursor-pointer bg-green-800 hover:bg-gray-400 font-extrabold text-[10px] p-1 m-1 rounded-sm">D|C</button>
                  <button className=" cursor-pointer bg-blue-900 hover:bg-gray-400 font-extrabold text-[10px] p-1 m-1 rounded-sm">W</button>
