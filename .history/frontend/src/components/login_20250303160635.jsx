...
const Login = () => {
  ...
  return (
    <div className="main flex items-center justify-center min-h-screen bg-[--primary-background]">
      <div className="bg-black p-6 w-75 border-[5px] border-[#3d3636]">
        <h2 className="text-2xl font-semibold text-center mb-4">RADHE Exchange</h2>
        <form className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="mt-1 p-2 w-full bg-[#ffffff] border rounded-lg focus:ring focus:ring-blue-300"
            />
          </div>
          ...
          {/* CAPTCHA */}
          <div className="flex justify-center items-center space-x-3 bg-[#d4d4d4] rounded-lg p-2">
