    ...
    <div className="relative">
      ...
      >
        <ul className="space-y-2 p-2">
          {[
            { key: "cricket", label: "Cricket", items: ["ICC Champions Trophy", "Women's Premier League, International T20 Masters League"] },
            ...
            <li key={key} className="cursor-pointer">
              ...
              >
                ...
                {items.map((item, index) => (
                  ...
                  >
                    <li className="text-gray-400 hover:text-white py-1">ICC Champions Trophy</li>
                    <li className="text-gray-400 hover:text-white py-1">India v Australia</li>
                    <li></li>
                  </ul>
                ))}
              </ul>
