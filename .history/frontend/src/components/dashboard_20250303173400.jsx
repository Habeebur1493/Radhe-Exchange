...
const Dashboard = () => {
  ...
  <li key={item} className="relative group">
    ...
    <div className="absolute left-0 mt-1 w-40 bg-[#18b0c7] text-gray-800 shadow-md rounded-md opacity-0 group-hover:opacity-100 group-hover:block transition-all duration-200 ease-in-out">
