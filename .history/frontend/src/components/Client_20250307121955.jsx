  ...
  <div className="h-auto lg:h-[700px]  w-full max-w-8xl bg-white rounded-lg m-4">
    ...
    <div className="flex flex-wrap items-center justify-between gap-2 p-4">
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        <button className="btn3 border border-gray-600  p-2 rounded-sm">Add Client Account</button>
        <button className="btn3 border border-gray-600  p-2 rounded-sm">Active List</button>
      </div>
    </div>
