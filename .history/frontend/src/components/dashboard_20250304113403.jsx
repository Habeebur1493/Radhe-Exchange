  ...
  return (
    <div className="dashboard min-h-screen bg-gray-100 overflow-x-hidden">
      ...
      <header className="bg-[#007182] p-2  ">
        ...
        {/* Dropdown Content */}
        {isOpen && (
          <div className="bg-[#007182] transition-all duration-300 pb-1">
          <div className="flex justify-evenly items-center text-white text-[14px] space-x-10">
            ...
            <div className="flex flex-col text-center gap-2">
              <h4 className="flex">Given Bal: <span className="text-[#20fa5e] ml-17">1000.00</span></h4>
              <h4 className="flex">Available: <span className="text-[#20fa5e] ml-20">500.00</span></h4>
            </div>
        
            <div className="flex flex-col text-center gap-2">
              <h4 className="flex">Up Line: <span className="ml-24">0</span></h4>
              <h4 className="flex">Down Line: <span className="ml-20">0</span></h4>
            </div>
        
            <div className="flex flex-col text-center gap-2">
              <h4 className="flex">Current P&L: <span className="ml-20">0</span></h4>
              <h4 className="flex">Exposure: <span className="ml-25">0</span></h4>
            </div>
        
            <div className="flex flex-col text-center gap-2 mb-7 mr-25">
              <h4 className="flex">My P&L: <span className="ml-20">0</span></h4>
            </div>
