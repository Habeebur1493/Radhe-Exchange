  ...
  return (
    <div className="min-h-screen bg-gray-100 overflow-x-hidden">
      ...
      <nav className="bg-[--primary-background] text-white flex justify-between items-center h-15 ">
        ...
        {/* Navbar Links */}
        <ul className="hidden md:flex gap-4 mr-100">
          <li><a href="#" className="hover:bg-[#18b0c7] p-5">Dashboard</a></li>
          <li><a href="#" className="hover:bg-[#18b0c7] p-5">Clients</a></li>
          <li><a href="#" className="hover:bg-[#18b0c7] p-5">Sport Analysis</a></li>
          <li><a href="#" className="hover:bg-[#18b0c7]">Casino Anbg-alysis</a></li>
