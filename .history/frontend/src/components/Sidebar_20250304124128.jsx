      ...
      >
        <ul className="space-y-2 ">
          ...
          <li className="cursor-pointer">
            <div className="flex justify-between items-center hover:bg-[#5dcbde] p-2 w-full" onClick={() => toggleDropdown("cricket")}>
          ...
          {/* Soccer */}
          <li className="cursor-pointer">
            <div className="flex justify-between items-center hover:bg-[#5dcbde]" onClick={() => toggleDropdown("soccer")}>
          ...
          {/* Tennis */}
          <li className="cursor-pointer">
            <div className="flex justify-between items-center hover:bg-[#5dcbde]" onClick={() => toggleDropdown("tennis")}>
          ...
          {/* Greyhound */}
          <li className="cursor-pointer">
            <div className="flex justify-between items-center hover:bg-[#5dcbde]" onClick={() => toggleDropdown("greyhound")}>
