    ...
    <ul className="hidden lg:block md:flex text-sm font-medium">
      ...
      <header className="bg-[#007182] p-1  ">
        ...
        {isOpen && (
          ...
          <div className="flex flex-wrap md:flex-nowrap justify-evenly items-center text-white text-[14px] w-full mr-4">
            
            <div className="flex flex-col text-center gap-2 w-full sm:w-1/2 md:w-auto">
            ...
            <div className="flex flex-col text-center gap-2 w-full sm:w-1/2 md:w-auto mb-7 pl-10">
              <h4 className="flex justify-evenly">
