        ...
        <div className="h-[700px] w-[1490px] bg-white rounded-lg">
            ...
            <table className="border-collapse border border-gray-400 ">
              <thead>
                ...
                <tr className="bg-[#f2f2f2] text-black">
                  <th className="border border-gray-400 p-2  text-right ">-</th>
                  <th className="border border-gray-400 p-2 text-right">
                    0.00
                  </th>
                  <th className="border border-gray-400 p-2 text-right">500</th>
                  <th className="border border-gray-400 p-2  text-right">
                    -500.00
                  </th>
                  <th className="border border-gray-400 p-2  text-right">
                ...
                <tr className="bg-white text-black">
                  ...
                  <th className="border border-gray-400 text-green-500 p-2 text-right">
                    500
                  </th>
                  <th className="border border-gray-400 p-2 text-red-500 text-right">
                    -500.00
                  </th>
                  <th className="border border-gray-400 p-2 text-green-500 text-right">
                    500.00
                  </th>
                  <th className="border border-gray-400 p-2  text-right">
                    0.00
                  ...
                  <th className="border border-gray-400 p-2 text-right ">
                    <button className=" cursor-pointer bg-orange-400 hover:bg-gray-400 font-extrabold text-[10px] text-white p-1 m-1 rounded-sm">
                      U
                    </button>
                    <button className=" cursor-pointer bg-green-800 hover:bg-gray-400 font-extrabold text-[10px] text-white p-1 m-1 rounded-sm">
                      D|C
                    </button>
                    <button className=" cursor-pointer bg-blue-900 hover:bg-gray-400 font-extrabold text-[10px] text-white p-1 m-1 rounded-sm">
                      W
                    </button>
                    <button className=" cursor-pointer bg-yellow-400 hover:bg-gray-400 font-extrabold text-[10px] p-1 m-1 rounded-sm">
                      P
                    </button>
                    <button className=" cursor-pointer bg-pink-400 hover:bg-gray-400 font-extrabold text-[10px] p-1 m-1 rounded-sm">
                      GC
                    </button>
                    <button className=" cursor-pointer bg-green-400 hover:bg-gray-400 font-extrabold text-[10px] p-1 m-1 rounded-sm">
                      CC
                    </button>
                  </th>
                </tr>
          ...
          <div className="flex justify-between items-center pl-10 pr-10">
            ...
            <div className="text-white text-[14px]">
              <button className="btn3 border border-gray-400 p-2 rounded-l-sm ">
                First
              </button>
              <button className="btn3 border border-gray-400 p-2 ">Prev</button>
              <button className="btnsp border border-gray-400 p-2 pl-4 pr-4 ">
                1
              </button>
              <button className="btn3 border border-gray-400 p-2 ">Next</button>
              <button className="btn3 border border-gray-400 p-2 rounded-r-sm ">
                Last
              </button>
            </div>
          </div>
