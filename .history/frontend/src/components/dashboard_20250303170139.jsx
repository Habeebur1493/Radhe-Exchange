        ...
        <ul className="hidden md:flex space-x-6 text-sm font-medium">
          ...
          {["Settlement", "Reports", "Cutting", "Control"].map((item) => (
            <li key={item} className="relative group">
              ...
              {/* Dropdown */}
              <div className="absolute left-0 mt-2 w-40 bg-[#18b0c7] text-gray-800 shadow-lg rounded-md hidden group-hover:block">
                <a href="#" className="block px-4 py-2 hover:bg-[#18b0c7]">Option 1</a>
