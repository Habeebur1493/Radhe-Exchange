...
const Dashboard = () => {
  ...
  return (
    <div className="dashboard min-h-screen w-full bg-gray-200 overflow-x-hidden ">
      {/* Navbar */}
  ...
  <div className="ml-auto">
    <ul className=" md:flex text-sm font-medium">
      ...
      <DashContent />
      <footer className="footer fixed bottom-0 w-full h-8 bg-[--secondary-background] text-white text-center">
  <marquee behavior="scroll" direction="left" scrollamount="5">
    1️⃣ Welcome To Our Exchange...... 2️⃣ ICC Champions Trophy Cup TOURNAMENT 
    WINNER Bet Started In Our Exchange..... 💫💫💫
  </marquee>
</footer>
    </div>
  );
