    ...
    <div className="dashboard min-h-screen bg-gray-100 overflow-x-hidden">
      ...
      <header className="bg-[#007182] p-2  ">
        ...
        {isOpen && (
          ...
          <div className="flex justify-between items-center text-white text-[14px] w-full mr-4">
            ...
            <div className="flex flex-col text-center gap-2 w-1/5">
              <h4 className="flex justify-between">
                Up Line: <span className="ml-2">0</span>
              </h4>
              <h4 className="flex justify-between">
            ...
            <div className="flex flex-col text-center gap-2 w-1/5">
              ...
              <h4 className="flex justify-between">
                Exposure: <span className="ml-2">0</span>
              </h4>
            </div>
        
            <div className="flex flex-col text-center gap-2 w-1/7 mb-7">
              <h4 className="flex justify-evenly">
                My P&L: <span className="ml-2">0</span>
              </h4>
            </div>
