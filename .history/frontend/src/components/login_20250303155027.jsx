    ...
    <div className="flex items-center justify-center min-h-screen bg-gray-100">
      <div className="bg-white p-6 rounded-xl shadow-lg w-96">
        ...
        <form className="space-y-4">
          ...
          {/* CAPTCHA */}
          <div className="flex justify-center items-center space-x-3 bg-[#d4d4d4] rounded-lg ">
            ...
            <input
              ...
              className="p-2 w-30 border rounded-lg bg-white focus:ring focus:ring-blue-300"
            />
            <button
              type="button"
