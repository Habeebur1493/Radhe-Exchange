    ...
    <div>
      <div className="client flex justify-center items-center h-screen bg-gray-300 min-h-screen">
        <div className="h-[700px] w-[1490px] bg-white rounded-lg">
          ...
          <div className="flex justify-between flex-wrap pl-5 pr-5 text-[14px]">
  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 w-full">
    <input className="border border-gray-400 rounded-sm p-1 m-1 w-full" type="text" placeholder="Search" />
    <input className="border border-gray-400 rounded-sm p-1 m-1 w-full" type="text" placeholder="Search by Client" />
  </div>

  <div className="flex flex-wrap justify-between items-center gap-2 w-full sm:w-auto mt-2 sm:mt-0">
