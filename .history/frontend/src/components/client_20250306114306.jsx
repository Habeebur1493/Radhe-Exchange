            ...
            <table className="border-collapse border border-gray-400 ">
              <thead>
                ...
                <tr className="bg-[#f2f2f2] text-black">
                  <th className="border border-gray-400 p-2 pr-5 text-right ">
                    -
                  </th>
                  <th className="border border-gray-400 p-2 pr-10 text-right">
                    0.00
                  </th>
                  <th className="border border-gray-400 p-2 pr-5text-right">
                    500
                  </th>
                  <th className="border border-gray-400 p-2 pr-5 text-right">
                    -500.00
                  ...
                  <th className="border border-gray-400 p-2 pr-3 text-right">
                    -
                  </th>
                  <th className="border border-gray-400 p-2 pr-5 text-right">
                    -
                  </th>
                  <th className="border border-gray-400 p-2 pr-40 text-right">
                    -
                  </th>
                </tr>
              </thead>
