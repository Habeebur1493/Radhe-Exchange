  ...
  return (
    <div className="p-4 ">
      ...
      <div className="flex flex-row gap-2 mt-4">
        <div className="h-5 w-10 bg-white rounded-sm"><h1 className="bg-[#16a2ba]">P&L</h1></div>
        <div className="h-[5%] w-[10%] bg-white rounded-sm"><h1>COMMISION</h1></div>
        <div className="h-[5%] w-[10%] bg-white rounded-sm"><h1>DEPOSIT</h1></div>
        <div className="h-[5%] w-[10%] bg-white rounded-sm"><h1>WITHDRAWL</h1></div>
        <div className="h-[5%] w-[10%] bg-white rounded-sm"><h1>TOTAL BETS</h1></div>
        <div className="h-[5%] w-[10%] bg-white rounded-sm"><h1>SPORTBOOK P&L</h1></div>
      </div>
    </div>
  );
};
