    ...
    <ul className=" md:flex text-sm font-medium">
      <li className="relative">
        <button
          ...
          className="flex items-center space-x-1 focus:outline-none px-4 h-14 text-[10px] lg:text-[14px]"
        >
          <span>User</span>
          <ChevronDown size={14} />
        </button>
      ...
      <header className="bg-[#007182] p-1  ">
        ...
        {isOpen && (
          ...
          <div className="grid grid-cols-2 gap-4 sm:grid-cols-2 lg:flex lg:justify-evenly items-center text-white text-[10px] sm:text-[12px] lg:text-[14px] w-full mr-4">
            ...
            <div className="flex flex-col text-center gap-2 w-full sm:w-1/2 lg:w-auto mb-7 pl-10">
              <h4 className="flex justify-evenly">
