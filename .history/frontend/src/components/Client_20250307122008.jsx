...
const Client = () => {
  ...
  <div className="h-auto lg:h-[700px]  w-full max-w-8xl bg-white rounded-lg m-4">
    ...
    <div className="flex flex-wrap items-center justify-between gap-2 p-4">
      ...
      <div className="flex flex-wrap items-center gap-2">
        <h2 className="font-bold text-sm">Show</h2>
        <select className="border border-gray-400 p-2 rounded-sm">
          <option value="25">25</option>
          <option value="50">50</option>
          <option value="100">100</option>
        </select>
        <h2 className="font-bold text-sm">Entries</h2>
        <button className="btn3 border border-gray-600  p-2 rounded-sm text-white">Add Client Account</button>
        <button className="btn3 border border-gray-600  p-2 rounded-sm text-white">Active List</button>
      </div>
    </div>
